    ...
    while current_date <= end_date:
        ...
        for stadium in range(1, 25):
            ...
            for rno in range(1, 13):
                ...
                # 💡 weather_information から確実に風速・風向を取得する
                ...
                # デバッグ用ログ出力
                print(f"DEBUG -> 場:{stadium} R{rno} | 風速:{wind_speed} 風向raw:{wind_dir_raw}")

                # 向い風・追い風の判定（数値コードまたは文字列に対応）
                # ボートレースの風向コード一般的な目安: 9〜11付近が南（向い風になりやすい場など）、文字判定も併用
